...
import LocationCheckBox from "@/components/locationChechBox";
...
export default async function updatingLocationPage({ params }: Props) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          <LocationCheckBox id={String(id)} locations={locations} />
          <input type="hidden" name="locationId" value={id} />
          <Button
            type="submit"
            variant="contained"
